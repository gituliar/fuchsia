...
In \fuchsia, fuchsification step is implemented by \code{fuchsify} and \code{fuchsify\_by\_blocks} routines, which are described in details in the next section.
...
In \fuchsia, normalization step is implemented by \code{normalize} and \code{fuchsify\_by\_blocks} routines, which are described in details in the next section.
